        ...
        <div class="password-settings-content">
          ...
          <div class="setting-group">
            <div class="setting-header">
              ...
              <p class="setting-description">Digite a nova senha (mínimo 4 caracteres)</p>
            </div>
            <div class="setting-control">
              <input 
                type="password" 
  ...
  methods: {
    ...
    validatePasswordForm() {
      ...
      if (!this.passwordForm.newPassword.trim()) {
        ...
        this.passwordErrors.newPassword = 'Nova senha deve ter pelo menos 4 caracteres'
      }
    ...
    async changePassword() {
      ...
      try {
        ...
        if (error.response?.status === 401) {
          ...
          errorMessage = error.response?.data?.error || error.message || 'Erro ao alterar senha'
        }
